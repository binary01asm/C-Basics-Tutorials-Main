...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .bg-orb-2 {
    ...
    background: radial-gradient(circle, #0891b2 0%, #164e63 50%, transparent 70%);
  ...
  .bg-orb-3 {
    ...
    background: radial-gradient(circle, #be185d 0%, #500724 50%, transparent 70%);
  ...
  .bg-orb-4 {
    ...
    top: 50%; right: -100px;
    background: radial-gradient(circle, #065f46 0%, #022c22 50%, transparent 70%);
  ...
  @keyframes drift2 { from { transform: translate(0,0) scale(1.05); } to { transform: translate(-80px, 50px) scale(0.95); } }
  @keyframes drift3 { from { transform: translate(0,0) scale(1); } to { transform: translate(40px,-60px) scale(1.15); } }
  ...
  h1 {
    ...
    letter-spacing: -3px;
    line-height: 1;
    background: linear-gradient(135deg, #fff 0%, #c4b5fd 40%, #67e8f9 80%, #34d399 100%);
  ...
  /* Subtle inner glow on email card */
  .email-card-glow::after {
    content: '';
    position: absolute;
    top: -60px; left: 50%;
  ...
  .email-address:hover {
    ...
    box-shadow: 0 0 20px rgba(103,232,249,0.12);
  }
  ...
  .btn-copy {
    ...
    color: #e9d5ff;
    box-shadow: 0 4px 16px rgba(124,58,237,0.25), 0 1px 0 rgba(255,255,255,0.1) inset;
  }

  .btn-copy:hover {
    background: linear-gradient(135deg, rgba(124,58,237,0.85), rgba(109,40,217,0.65));
    box-shadow: 0 6px 24px rgba(124,58,237,0.4), 0 1px 0 rgba(255,255,255,0.12) inset;
  }
  ...
  .dot.offline { background: var(--text-muted); box-shadow: none; animation: none; }
  ...
  .mail-item:hover {
    ...
    box-shadow: 0 4px 20px rgba(0,0,0,0.3), -4px 0 0 rgba(167,139,250,0.4);
  }

  .mail-item.unread .mail-subject { color: rgba(255,255,255,0.75); }
  .mail-item .mail-subject { color: var(--text-muted); }
  ...
  .mail-avatar {
    ...
    font-weight: 500;
    color: white;
    background: linear-gradient(135deg, rgba(124,58,237,0.7), rgba(8,145,178,0.6));
...
<main>
  ...
  <!-- Email address card -->
  <div class="glass-card email-card-glow">
    ...
    <div class="status-bar">
      ...
      <span style="margin-left:auto" id="lastRefresh" class="hint-text"></span>
    </div>
  </div>
  ...
  <div class="glass-card">
    <div class="inbox-header">
      ...
      <span class="hint-text">auto-refreshes every 15s</span>
    </div>
    <div id="mailList">
